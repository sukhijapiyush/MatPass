...
<body class="container">
	...
	<h6>
		...
		<div align="center">
			<br>
			<h5><b><i>List Of Returnable Records</i></b></h5>
				...
				<tbody>
					...
					<%
						...
						try {
							...
							rst = stmt
									.executeQuery("SELECT id,type,purpose,pdesc,bdesc,valid,auth,ret FROM records WHERE auth=" + 1+" AND ret="+1);
							while (rst.next()) {
								if (i == (i / 2) * 2) {
					%>
					<tr>
						...
						<td><a href="ret.jsp?id=<%=rst.getInt("id")%>"> Material
								Returned </a></td>
					</tr>
					<%
						} else {

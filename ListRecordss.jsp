...
<body class="container">
	...
	<div align="center">
		<br>
		<h5><b><i>List Of Authorized Records</i></b></h5>
			...
			<tbody>
				...
				<%
					...
					try {
						...
						rst = stmt
								.executeQuery("SELECT id,type,purpose,pdesc,bdesc,valid,auth,ret FROM records WHERE auth=" + 1);
						while (rst.next()) {
							if (i == (i / 2) * 2) {
				%>
				<tr>
					...
					<td><a href="views.jsp?id=<%=rst.getInt("id")%>"> View
							Record </a></td>
				</tr>
				<%
					} else {
